...
export const createGameLobby = (gameOptions) => {
  return (dispatch, getState, {getFirebase, getFirestore}) => {
    ...
    fireStore.collection('gameLobbys').add(newGameLobby).then((gameLobby) => {
...
export const joinLobby = (lobbyId, takeSeat, seatIndex) => {
  return (dispatch, getState, { getFirestore}) => {
    ...
    fireStore.runTransaction((transaction) => {
      ...
      fireStore.collection('currentLobbys').doc(playerId).set(datas)
...
export const deleteLobby = (lobbyId) => {
  return (dispatch, getState, {getFirebase, getFirestore}) => {
    ...
    let deleteLobby = getFirebase().functions().httpsCallable('deleteLobby');

    deleteLobby({lobbyId}).then(function(result) {
