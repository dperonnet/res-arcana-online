...
class Profile extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      prevProps.profile.cardSize !== this.props.profile.cardSize ||
      prevProps.profile.layout !== this.props.profile.layout
    ) {
      let state = this.state
      state.cardSize = this.props.profile.cardSize
      state.layout = this.props.profile.layout
  ...
  renderLayout = () => {
    ...
    return (
      <Form.Group as={Row} controlId="layout">
  ...
  renderCard = size => {
    ...
    return (
      <div className="card-settings">
        ...
        >
          <Card classes={size + ' card vertical'} src={src} show={true} alt={size} />
        </div>
      ...
      <div className="auth-container">
          ...
          <Form onSubmit={this.handleSubmitProfile}>
            ...
            <Row>
              <div className="offset-4 col-7">
                <Button type="submit" size="sm" disabled={this.disableSubmit()}>
                  Save
                </Button>
              </div>
            </Row>
        ...
        <div className="auth-panel">
          ...
          <Form onSubmit={this.handleSubmitOptions}>
            ...
            <Row>
              <div className="offset-4 col-7">
                <Button type="submit" size="sm" disabled={disableSaveOption}>
                  Save
                </Button>
              </div>
            </Row>
