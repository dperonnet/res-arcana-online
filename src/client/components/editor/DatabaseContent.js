  ...
  render() {
    ...
    return (
      <div className="form-panel">
        ...
        <ButtonToolbar>
          <Button variant="secondary" size="sm" onClick={this.handleCreate}>
            Create
          </Button>
          <Button variant="secondary" size="sm" onClick={this.handleDelete} disabled={!pristineComponent.id}>
            Delete
          </Button>
          <Button variant="secondary" size="sm" onClick={this.copyDatabaseToClipboard}>
            Copy database
          </Button>
        </ButtonToolbar>
      </div>
