...
import {
  ...
  DISCOUNT,
  REACT_POWER,
  SPECIFIC_COLLECT_ABILITY,
  STANDARD_COLLECT_ABILITY,
...
class ComponentForm extends Component {
  ...
  getDefaultComponent = () => {
    ...
    const component = Object.keys(pristineComponent).length !== 0 ? pristineComponent : DEFAULT_COMPONENT
            ...
            <Form.Group controlId="ComponentSettingsForm">
              ...
              <InputGroup className="mb-2">
                <Form.Check
                  inline
                  type="checkbox"
                  name="hasStandardCollectAbility"
                  id="hasStandardCollectAbility"
                  label="Has standard collect ability"
              ...
              {component.hasStandardCollectAbility && (
                <>
                  <div className="mb-2">
                    <EssencePanel
                      essenceList={
                        (component.standardCollectAbility && component.standardCollectAbility.essenceList) || []
                      }
              ...
              <InputGroup className="mb-2">
                <Form.Check
                  inline
                  type="checkbox"
                  name="hasSpecificCollectAbility"
                  id="hasSpecificCollectAbility"
                  label="Has specific collect ability"
                ...
                <>
                  <div className="mb-2">
                    <EssencePanel
                      panelType="all"
                      essenceList={
                        (component.specificCollectAbility && component.specificCollectAbility.essenceList) || []
                      }
                  ...
                  <div className="mb-2">
                    <InputGroup className="mb-2">
                      <Form.Check
                        inline
                        type="checkbox"
                        name="multipleCollectOptions"
                        id="multipleCollectOptions"
                        label="Player can choose essences"
              ...
              {component.type === 'monument' && (
                <InputGroup className="mb-2">
                  <Form.Check
                    inline
                    type="checkbox"
                    name="hasPlacementPower"
                    id="hasPlacementPower"
                    label="Has placement power"
                ...
                <>
                  <div className="inline-block mb-2">
                    <Form.Check
                      inline
                      type="checkbox"
                      name="hasVictoryPoint"
                      id="hasVictoryPoint"
                      label="Has victory point(s)"
                  ...
                  {component.hasVictoryPoint && (
                    <div className="inline-input">
                      <InputGroup.Prepend>
                        <InputGroup.Text className="victory-points" id="victoryPoint">
                          {component.victoryPoint || 0}
                        </InputGroup.Text>
                      </InputGroup.Prepend>
                      <InputGroup.Append>
                        <div className="vertical-buttons">
                          <Button
                            variant="secondary"
                            id="lowerVictoryPoint"
                            onClick={() => this.increment('victoryPoint')}
                          >
                            <span>+</span>
                          </Button>
                          <Button
                            variant="secondary"
                            id="raiseVictoryPoint"
                            onClick={() => this.decrement('victoryPoint')}
                          >
                            <span>-</span>
                          </Button>
                        </div>
                ...
                <>
                  <InputGroup className="mb-2">
                    <Form.Check
                      inline
                      type="checkbox"
                      name="hasConditionalVictoryPoint"
                      id="hasConditionalVictoryPoints"
                      label="Has conditional victory point(s)"
              ...
              <ButtonToolbar>
                <Button variant="secondary" size="sm" onClick={onSave} disabled={!component.name.trim()}>
                  Save
                </Button>
        ...
        <div className="inline-input" key={index}>
          <InputGroup.Prepend>
            <InputGroup.Text className={'essence ' + type + classModifier} id={type + 'Essence'}>
              ...
              {signModifier}
              {(essence && essence.quantity) || 0}
            </InputGroup.Text>
          </InputGroup.Prepend>
          <InputGroup.Append>
            <div className="vertical-buttons">
              <Button variant="secondary" id={'lower' + type + 'CollectOptions'} onClick={() => this.increment(type)}>
                <span>+</span>
              </Button>
              <Button variant="secondary" id={'raise' + type + 'Essence'} onClick={() => this.decrement(type)}>
                <span>-</span>
              </Button>
            </div>
          </InputGroup.Append>
    ...
    <>
      <InputGroup className="mb-2">
        <Form.Check
          inline
          type="checkbox"
          name="hasDiscountAbility"
          id="hasDiscountAbility"
          label="Has discount ability"
                ...
                <div className="inline-block mb-2">
                  {discountTypes.map(discountType => (
                    <Form.Check
                      ...
                      name="discountType"
                      className="ml-2"
                      key={index + '_type_' + discountType.id}
  ...
  return (
    <>
      ...
      {component.hasReactPower &&
        reactPowers.map((reactPower, index) => (
          <div key={index} className="mb-2 ml-2">
            <InputGroup>
                ...
                <div className="inline-block">
                  {reactPowerTypes.map(reactPowerType => (
                    <Form.Check
                      ...
                      name="reactPowerType"
                      className="ml-2"
                      key={index + '_type_' + reactPowerType.id}
              ...
              <div className="ml-1">
                ...
                <div className="mb-2 inline-block">
                  <Form.Check
                    inline
                    type="checkBox"
                    name="gainOnComponent"
                    label={
                      <>
                        Essence gain on component <div className="icon on-component-icon"></div>
                      </>
                    }
                ...
                {reactPowers[index].type.filter(type => type === 'VICTORY_CHECK').length > 0 && (
                  <div className="mb-2 ml-2 inline-block">
                    ...
                    <div className="inline-input">
                      <InputGroup.Prepend>
                        <InputGroup.Text className="victory-points" id="victoryPoint">
                          {reactPower.gain.temporaryVictoryPoints || 0}
                        </InputGroup.Text>
                      </InputGroup.Prepend>
                      <InputGroup.Append>
                        <div className="vertical-buttons">
                          <Button variant="secondary" id="lowerVictoryPoint" onClick={() => increment(index)}>
                            <span>+</span>
                          </Button>
                          <Button variant="secondary" id="raiseVictoryPoint" onClick={() => decrement(index)}>
                            <span>-</span>
                          </Button>
                        </div>
                      </InputGroup.Append>
  ...
  return (
    <>
      ...
      {component.hasActionPower &&
        actionPowers.map((actionPower, index) => (
          <div key={index} className="mb-2 ml-2">
            <InputGroup>
            ...
            <div className="mb-2 ml-2">
              ...
              <div className="ml-1">
                ...
                {renderCheckBoxCost(index, 'onlyWhenTurned', <>When this card is turned</>)}
                {splitter}
                {renderCheckBoxCost(index, 'multipleCostOptions', <>The player can choose which essence to pay</>)}
                {splitter}
                <label className="ml-2">
                  <EssencePanel
                    or={actionPower.cost.multipleCostOptions}
                    cost={true}
                  ...
                  {renderCheckBoxCost(
                    ...
                    <>
                      +{' '}
                      <div className="essence any-same-type">
                ...
                {splitter}
                {renderCheckBoxCost(index, 'destroyOneArtefact', <>Destroy one of your artifacts</>)}
                {splitter}
                {renderCheckBoxCost(index, 'destroyOneDragonOrCreature', <>Destroy one of your Dragons or Creatures</>)}
                {splitter}
                {renderCheckBoxCost(index, 'destroyAnotherArtefact', <>Destroy another of your artifacts</>)}
                {splitter}
                {renderCheckBoxCost(index, 'discardArtefact', <>Discard a card</>)}
              </div>
            </div>
              ...
              <div className="ml-1">
                ...
                {renderCheckBoxGain(
                  ...
                  <>
                    ...
                    as{' '}
                    <div className="essence gold mt-n2">
                ...
                {renderCheckBoxGain(
                  index,
                  'powerCostAsAnySameTypeButGold',
                  <>
                    <div className="essence any-same-type">
                      <div className="cost"></div>
                    </div>{' '}
                    as <div className="essence any-same-type-but-gold mt-n2"></div>
                  </>
                )}
                {splitter}
                {renderCheckBoxGain(
                ...
                {renderCheckBoxGain(
                  index,
                  'placementCostAsAnyButGold',
                  <>
                    <div className="icon placement-cost-icon">
                      <div className="qm-dark"></div>
                    </div>{' '}
                    as <div className="essence any-but-gold"></div> with modifier
                    <EssencePanel
                      panelType="anyButGold"
                      modifier={true}
                ...
                {renderCheckBoxGain(
                  ...
                  'placeDragon',
                  <>
                    Place <div className="icon dragon-icon"></div> at{' '}
                    <div className="icon placement-cost-icon">
                      <div className="qm-dark"></div>
                    </div>{' '}
                    with modifier
                ...
                {renderCheckBoxGain(
                  index,
                  'placeArtefactFromDiscard',
                  <>
                    Place any of your discards at{' '}
                    <div className="icon placement-cost-icon">
                      <div className="qm-dark"></div>
                    </div>{' '}
                    with modifier
                ...
                {splitter}
                {renderCheckBoxGain(index, 'checkVictoryNow', <>Check victory now!</>)}
                {splitter}
                {renderCheckBoxGain(index, 'rivalsGain', <>All Rivals Gain</>)}
                  ...
                  <input
                    ...
                    onChange={() =>
                      updateActionPower(
                        ...
                        'gain',
                        'rivalsLoseLife',
                        actionPower.gain.rivalsLoseLife !== 1 ? 1 : null
                      )
                    }
                  />
                  ...
                  <input
                    ...
                    onChange={() =>
                      updateActionPower(
                        ...
                        'gain',
                        'rivalsLoseLife',
                        actionPower.gain.rivalsLoseLife !== 2 ? 2 : null
                      )
                    }
                  />
                ...
                {actionPowers[index]['gain']['rivalsLoseLife'] && (
                  <div className="ml-2">
                    Rivals can ignore life loss with
                    <EssencePanel
                      cost={true}
                ...
                {actionPowers[index]['gain']['rivalsLoseLife'] &&
                  renderCheckBoxGain(
                    index,
                    'canIgnoreWithDiscardArtefact',
                    <>Rivals can discard one card to ignore life loss</>
                  )}
                {splitter}
                {renderCheckBoxGain(index, 'drawOne', <>Draw 1 card</>)}
                {splitter}
                {renderCheckBoxGain(index, 'drawThreeDiscardThree', <>Draw 3 cards, add to hand, discard 3</>)}
                {splitter}
                {renderCheckBoxGain(
                  index,
                  'reorderThree',
                ...
                {renderCheckBoxGain(
                  index,
                  'asManyCalmThanRivalsElan',
                  <>
                    Gain <div className="essence calm">?</div> equal to <div className="essence elan">?</div> of one
                    rival
                  </>
                )}
                {splitter}
                {renderCheckBoxGain(
                  index,
                  'asManyElanThanRivalsDeath',
                  <>
                    Gain <div className="essence elan">?</div> equal to <div className="essence death">?</div> of one
                    rival
                  </>
                )}
              </div>
